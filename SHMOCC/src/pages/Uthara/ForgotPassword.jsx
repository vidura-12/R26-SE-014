          ...
          <div style={{
            ...
            {step === 0 && (
              <div className="panel" key="step0">
                ...
                <p style={{ textAlign:"center",fontSize:14,color:"#7aaa8a" }}>
                  ...
                  <span onClick={() => nav("/disease-prediction/login")} style={{ color:"#1a5c2e",fontWeight:700,cursor:"pointer",textDecoration:"underline" }}>Sign In</span>
                </p>
              </div>
            )}
            ...
            {step === 3 && (
              <div className="panel" key="step3" style={{ textAlign:"center" }}>
                ...
                <button
                  onClick={() => nav("/disease-prediction/login")}
