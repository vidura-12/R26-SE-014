...
function RegisterModal({ t }) {
  ...
  const inputStyle = (err) => ({
    ...
    borderRadius: 12,
    fontSize: 14,
    border: `2px solid ${err ? "#dc2626" : t.inputBorder}`,
    outline: "none",
      ...
      >
        {regSuccess ? (
          <div style={{ padding: "64px 48px", textAlign: "center" }}>
            ...
            >
              Your sensor is now active and monitoring
            </p>
          </div>
        ) : (
              ...
              <div>
                <div
                  style={{
                    ...
                    height: 52,
                    borderRadius: 16,
                    background: t.blueChipBg,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontSize: 24,
                    marginBottom: 12,
                    border: `1.5px solid ${t.blueChipBorder}`,
                  }}
                >
                  📡
                </div>
                ...
                >
                  Add a sensor to your plantation monitoring network
                </p>
              </div>
            ...
            >
              ...
              >
                ...
                <p
                  style={{
                    fontSize: 13,
                    color: t.__isDark ? "#4ade80" : "#15803d",
                    lineHeight: 1.7,
                    fontWeight: 600,
                  }}
                >
                  The Device ID is printed on your sensor hardware. After
                  registration, the device will begin sending data within 5
                  minutes.
                </p>
              </div>
      ...
      >
        {editSuccess ? (
          <div style={{ padding: "64px 48px", textAlign: "center" }}>
            ...
            >
              Your sensor details have been saved successfully.
            </p>
          </div>
        ) : (
          <div style={{ padding: "36px 40px" }}>
            ...
            >
              <div>
                ...
                >
                  Update your sensor details below
                </p>
              </div>
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  style={inputStyle(editErrors.deviceId)}
                />
      ...
      <style>{`
        ...
        * {
        ...
        ::-webkit-scrollbar-thumb {
          background: ${t.dashedBorder};
          border-radius: 99px;
        }

        .history-row:hover {
          filter: brightness(${t.__isDark ? 1.15 : 0.98});
        }
            ...
            >
              <div
                style={{
                  ...
                  flexShrink: 0,
                  boxShadow:
                    "0 4px 16px rgba(16, 185, 129, 0.35), inset 0 1px 0 rgba(255,255,255,0.2)",
                }}
              >
                🌿
              </div>
