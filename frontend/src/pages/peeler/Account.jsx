...
export default function PeelerAccount() {
    ...
    <div className="space-y-6 animate-slide-up max-w-2xl">
      ...
      <div className="card p-5 sm:p-6">
        <div className="flex items-center gap-4">
          <div className="h-14 w-14 rounded-full bg-forest-100 flex items-center justify-center text-forest-700 font-bold text-xl flex-shrink-0">
